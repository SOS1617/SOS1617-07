...
exports.register = function(app, dbJose, BASE_API_PATH2) {
...
//Load Initial Data
app.get(BASE_API_PATH2 + "/investEducationStats/loadInitialData",function(request, response) {
...
app.get(BASE_API_PATH2 + "/investEducationStats", function (request, response) {
...
app.get(BASE_API_PATH2 + "/investEducationStats/:year", function (request, response) {
...
app.get(BASE_API_PATH2 + "/investEducationStats/:country/:year", function (request, response) {
...
app.post(BASE_API_PATH2 + "/investEducationStats", function (request, response) {
...
app.post(BASE_API_PATH2 + "/investEducationStats/:country", function (request, response) {
...
app.put(BASE_API_PATH2 + "/investEducationStats", function (request, response) {
...
app.put(BASE_API_PATH2 + "/investEducationStats/:country/:year", function (request, response) {
...
app.delete(BASE_API_PATH2 + "/investEducationStats", function (request, response) {
...
app.delete(BASE_API_PATH2 + "/investEducationStats/:country/:year", function (request, response) {
